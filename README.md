...
This project was developed mainly with the assistance of [Claude Code](https://claude.com/claude-code).

While the code was generated with AI assistance, it has been reviewed and tested to ensure:
